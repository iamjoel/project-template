  ...
  <div class="sc-search-condition">
   ...
   <el-form :inline="true" ref="form" label-position="right" >
      ...
      <el-row type="flex" justify="end" class="sc-search-condition__ops">
        ...
        <el-button type="text" v-if="hasExpend" @click="isExpend = !isExpend" class="sc-search-condition__toggle-btn" :class="{'is-expend': isExpend}">{{isExpend ? '收起' :'展开'}}<i class="el-icon-arrow-down el-icon--right"></i></el-button>
